...
const PagesMenu = ({ hideOnTutorial = false }) => {
  ...
  const menuItems = [
    {
      name: "breathingExercisePage",
      title: "Breathing Exercise Page",
      icon: "leaf-outline",
    },
    {
      name: "skipBreathing",
      title: "Skip Breathing Exercise",
      icon: "fast-forward",
      isSkip: true,
    },
    {
      name: "startPhysicalFlow",
      title: "Start Physical Exercise Flow",
      icon: "play-circle",
      isPhysicalFlow: true,
    },
        ...
        >
          <View style={styles.menuContainer}>
            ...
            >
              ...
              <Text style={[styles.menuItemText, styles.testText]}>
                Mark All Daily Complete (Test)
              </Text>
            </Pressable>
            ...
            {completedExercises.length > 0 && (
              <>
                ...
                >
                  ...
                  <Text style={[styles.menuItemText, styles.resetText]}>
                    Reset All Exercises
                  </Text>
                </Pressable>
              </>
